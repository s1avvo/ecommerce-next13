...
export type CartCreateOrderMutationVariables = Exact<{ [key: string]: never; }>;


export type CartCreateOrderMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, name: string, price: number, description: string, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> } | null }> } | null };

export type CartDeleteProductMutationVariables = Exact<{
  itemId: Scalars['ID']['input'];
}>;


export type CartDeleteProductMutation = { deleteOrderItem?: { id: string } | null };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, name: string, price: number, description: string, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> } | null }> } | null };
...
export type CollectionsGetCollectionBySlugQuery = { collections: Array<{ id: string, name: string, slug: string }> };

export type CollectionsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionsGetListQuery = { collections: Array<{ id: string, name: string, slug: string, image: { url: string, fileName: string } }> };

export type CartFragment = { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, name: string, price: number, description: string, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> } | null }> };

export type SingleProductItemFragment = { id: string, name: string, price: number, description: string, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> };

export type ProductImageFragment = { url: string, fileName: string };

export type SingleProductSizeColorVariantFragment = { id: string, name: string };

export type SingleProductColorVariantFragment = { id: string, name: string };

export type SingleProductSizeVariantFragment = { id: string, name: string };

export type ProductListItemFragment = { id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> };

export type ReviewItemFragment = { id: string, name: string, headline: string, email: string, content: string, rating: number };

export type OrderUpdateCheckoutStripeIdMutationVariables = Exact<{
  id?: InputMaybe<Scalars['ID']['input']>;
  stripeCheckoutId?: InputMaybe<Scalars['String']['input']>;
}>;


export type OrderUpdateCheckoutStripeIdMutation = { updateOrder?: { id: string } | null };
...
export type ProductGetByIdQuery = { product?: { id: string, name: string, price: number, description: string, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> } | null };
...
export type ProductsCountByCategorySlugQueryVariables = Exact<{
  slug: Scalars['String']['input'];
}>;


export type ProductsCountByCategorySlugQuery = { categories: Array<{ id: string, name: string, slug: string, products: Array<{ id: string }> }> };
...
export type ProductGetListQuery = { productsConnection: { products: Array<{ node: { id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> } }>, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean } } };

export type ProductsGetListByCategorySlagQueryVariables = Exact<{
  slag: Scalars['String']['input'];
  limit: Scalars['Int']['input'];
  offset: Scalars['Int']['input'];
  orderBy?: InputMaybe<ProductOrderByInput>;
}>;
...
export type ProductsGetListByCategorySlagQuery = { productsConnection: { products: Array<{ node: { id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> } }>, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean } } };

export type ProductsGetListByCollectionSlagQueryVariables = Exact<{
  slag: Scalars['String']['input'];
}>;


export type ProductsGetListByCollectionSlagQuery = { products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> }> };
...
export type ProductsGetListSearchQuery = { products: Array<{ id: string, name: string, price: number, averageRating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string, fileName: string }> }> };
...
export type ReviewGetByProductIdQuery = { reviewsConnection: { edges: Array<{ node: { id: string, name: string, headline: string, email: string, content: string, rating: number } }> } };
...
export type ReviewPublishMutation = { publishReview?: { id: string, name: string, headline: string, email: string, content: string, rating: number } | null };
...
export const SingleProductItemFragmentDoc = new TypedDocumentString(`
  ...
  url
  fileName
}`, {"fragmentName":"SingleProductItem"}) as unknown as TypedDocumentString<SingleProductItemFragment, unknown>;
...
export const CartCreateOrderDocument = new TypedDocumentString(`
...
fragment ProductImage on Asset {
  url
  fileName
}`) as unknown as TypedDocumentString<CartCreateOrderMutation, CartCreateOrderMutationVariables>;
export const CartDeleteProductDocument = new TypedDocumentString(`
    mutation CartDeleteProduct($itemId: ID!) {
  deleteOrderItem(where: {id: $itemId}) {
    id
  }
}
    `) as unknown as TypedDocumentString<CartDeleteProductMutation, CartDeleteProductMutationVariables>;
...
export const OrderUpdateCheckoutStripeIdDocument = new TypedDocumentString(`
  ...
  updateOrder(data: {stripeCheckoutId: $stripeCheckoutId}, where: {id: $id}) {
    ...
    `) as unknown as TypedDocumentString<OrderUpdateCheckoutStripeIdMutation, OrderUpdateCheckoutStripeIdMutationVariables>;
...
export const ProductsCountByCategorySlugDocument = new TypedDocumentString(`
  ...
  categories(where: {slug: $slug}) {
    ...
    `) as unknown as TypedDocumentString<ProductsCountByCategorySlugQuery, ProductsCountByCategorySlugQueryVariables>;
...
export const ProductsGetListByCategorySlagDocument = new TypedDocumentString(`
...
fragment ProductListItem on Product {
  ...
  averageRating
}`) as unknown as TypedDocumentString<ProductsGetListByCategorySlagQuery, ProductsGetListByCategorySlagQueryVariables>;
export const ProductsGetListByCollectionSlagDocument = new TypedDocumentString(`
...
fragment ProductListItem on Product {
  ...
  averageRating
}`) as unknown as TypedDocumentString<ProductsGetListByCollectionSlagQuery, ProductsGetListByCollectionSlagQueryVariables>;
